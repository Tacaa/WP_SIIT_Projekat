...
public class ManifestacijaDAO {
	...
	public static void ucitajManifestacije(){
		...
		Manifestacija m1 = new Manifestacija("Makarena ponovo bruji", TipManifestacije.PLESNI_NASTUP, 
				...
				LokacijaDAO.lokacije.get(0), "ples.png", 32, new ArrayList<>(), 4.7, "lidija");
		...
		Manifestacija m2 = new Manifestacija("Kuvari u akciji", TipManifestacije.DRUGA_KATEGORIJA, 
				...
				LokacijaDAO.lokacije.get(1), "drugo.jpg", 22, new ArrayList<>(), 3.4, "lidija");
		...
		Manifestacija m3 = new Manifestacija("Zenska odbojka", TipManifestacije.SPORTSKA_NADMETANJA, 
				...
				LokacijaDAO.lokacije.get(3), "utakmica.jpg", 22, new ArrayList<>(), 0, "lidija");
		...
		Manifestacija m4 = new Manifestacija("Dragana Kostic nastupa", TipManifestacije.STANDUP_NASTUP, 
				...
				LokacijaDAO.lokacije.get(4), "standup.jpg", 17, new ArrayList<>(), 0, "lidija");
		...
		Manifestacija m5 = new Manifestacija("Mawka", TipManifestacije.BIOSKOPSKA_PROJEKCIJA, 
				...
				LokacijaDAO.lokacije.get(2), "kino.jpg", 31, new ArrayList<>(), 0, "lidija");
		...
		Manifestacija m6 = new Manifestacija("Koncert Nine Badric", TipManifestacije.KONCERT, 
				...
				"koncert.png", 0, new ArrayList<Komentar>(), 0, "daca");
		...
		Manifestacija m8 = new Manifestacija("Knjizevno vece sa Neletom Karajlicem - 'Fajront u Sarajevu'", 
				...
				"Novi Sad", "Srbija", 21000), "knjizevno_vece.png", 0, new ArrayList<Komentar>(), 0, "daca");
		...
		Manifestacija m9 = new Manifestacija("Odbojka Srbija - Poljska", TipManifestacije.SPORTSKA_NADMETANJA, 
				...
				"Beograd", "Srbija", 10401), "utakmica.jpg", 0, new ArrayList<Komentar>(), 0, "daca");
		...
		Manifestacija m10 = new Manifestacija("Smijeh lijeci sve", TipManifestacije.STANDUP_NASTUP, 
				...
				"standup.jpg", 0, new ArrayList<Komentar>(), 0, "daca");
		...
		Manifestacija m12 = new Manifestacija("ARSENAL", TipManifestacije.FESTIVAL, 30000, 
				...
				0, new ArrayList<Komentar>(), 0, "nana");
		...
		Manifestacija m13 = new Manifestacija("Noc istrazivaca", TipManifestacije.FESTIVAL, 
				...
				LokacijaDAO.lokacije.get(0), "festival.jpg", 0, new ArrayList<>(), 0, "nana");
		...
		//dodavanje manifestacije u listu manifestacija njegovog kreatora (prodavca)
		for(int i = 0; i<manifestacije.size(); i++) {
			Prodavac prodavac = ProdavacDAO.prodavci.get(manifestacije.get(i).getProdavac());
			prodavac.getManifestacije().add(manifestacije.get(i));
		}
